...
export default function UpdateEventPage({ event }: Props) {
	...
	return (
		<>
			...
			<ConsoleLayout page={Pages.CreateEvent} backBtn={`/console/events/${eventDetails._id}/manage`} maxW="max-w-4xl">
				<Formik initialValues={initialValues as CreateEventFormData} onSubmit={onSubmit} innerRef={formikRef} enableReinitialize={true}>
					{({ values, setFieldValue }) => (
						<Form>
							<Flex direction={{ base: "column", md: "row" }} gap={8} p={8} borderRadius="2xl" maxW="900px" mx="auto" boxShadow="2xl">
								...
								<Box flex="1">
									...
									<Flex gap={4} alignItems="center" justifyContent="space-between" mb="4" bg="#14161B" rounded="xl" p="2">
									...
									<FormControl mb={4}>
										<InputGroup>
											...
											<Field ref={ref} as={Input} id="location" name="location" placeholder="Choose Location" bg="#141619" color="white" border="none" pl="10" value={values.location} />
										</InputGroup>
									</FormControl>
									<FormControl mb={4}>
										<InputGroup>
											...
											<Field as={Textarea} name="desc" placeholder="Add Description" bg="#141619" color="white" border="none" rows="8" pl="10" value={values.desc} />
										</InputGroup>
									</FormControl>
									...
									<Box bg="#141619" rounded="xl" px="3" py="2">
										...
										<Flex align="center" justifyContent="space-between" mb="4">
											...
											<Field as={Input} type="number" min={0} value={values.capacity || 0} name="capacity" bg="#1C1F24" color="white" border="none" w="80px" h="30px" />
										</Flex>
													...
													{values.tickets.map((ticket, index) => (
														...
														>
															<Box>
																...
																<Text fontSize="lg" fontWeight="bold" color="#F79432">
																	${ticket.price}
																</Text>
															</Box>
															...
															<Box position="absolute" top="3" right="3">
																<Menu>
																	<MenuButton as={IconButton} icon={<VerticalDotsSVG />} variant="ghost" size="sm" color="white" _hover={{ bg: "#333" }} _active={{ bg: "#444" }} />
																	<MenuList bg="#1D1F24" border="1px solid #444" color="white">
																		...
																		<MenuItem bg="transparent" _hover={{ bg: "#333" }} onClick={() => remove(index)}>
																			Delete
																		</MenuItem>
																	</MenuList>
																</Menu>
									...
									<Button type="submit" mt="10" bg="#F79432" size="lg" width="100%" borderRadius="xl" color="black" isLoading={isSubmitting} isDisabled={isSubmitting || isUploading}>
										Update Event
									</Button>
