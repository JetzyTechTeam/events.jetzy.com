...
export default function EventsPage() {
  ...
  return (
    <ConsoleLayout page={Pages.Events}>
      <h1 className="text-white text-center text-2xl font-bold capitalized">Create New Event</h1>
            ...
            <Form className="space-y-6 md:w-5/12 xs:w-full" action="#" method="POST">
              ...
              <section className="bg-slate-300 space-y-6 p-3 rounded-lg">
                ...
                <div>
                  ...
                  <div className="mt-2">
                    <Field id="eventDate" name="datetime" value={values?.datetime} onChange={handleChange} type="text" autoComplete="datetime" className="block w-full h-12 rounded-md border-0 py-1.5 text-gray-900 shadow-sm ring-1 ring-inset ring-app placeholder:text-gray-400 focus:ring-2 focus:ring-inset focus:ring-app sm:text-sm sm:leading-6 p-3" />
