	...
	return (
		<div className="min-h-screen bg-black text-white p-6 md:p-12">
			<div className="max-w-4xl mx-auto">
				...
				<p className="mb-4 text-gray-400">Last Updated: August 5, 2026</p>
				...
				<div className="prose prose-invert max-w-none space-y-6 text-gray-300 text-sm leading-relaxed">
					...
					<p>
						...
						By registering, you expressly agree to create a Jetzy Account using your true given name and current email address. In order to use certain features of the Site or Services, you must register for an account (&quot;Account&quot;) and provide certain information about yourself as prompted by the account registration form. You represent and warrant that: (a) all required registration information you submit is truthful and accurate; (b) you will maintain the accuracy of such information. You may delete your Account at any time, for any reason, by following the instructions on the Site or Services or uninstalling the App. You may not have more than one Account. You agree not to create an Account or use the Site or Services if you have been previously removed by us or banned from any of the Services. Company reserves the right in its sole discretion to suspend or terminate your Account and refuse any and all current or future use of the Site or Services (or any portion thereof) at any time for any reason.
					</p>
					<p>
					...
					{/* Recurring-billing disclosure. The checkout T&C checkbox links here, and this
					    is now the only place the auto-renewal terms are set out in full — the
					    separate consent checkbox was removed. Keep it consistent with what the
					    code actually does: see src/lib/premium-bundle.ts (how a ticket sells a
					...
					<p>
						...
						Except where required by law, subscription fees and ticket purchases are non-refundable, including for
						partly used billing periods and for events you do not attend.
					</p>
					<p>
