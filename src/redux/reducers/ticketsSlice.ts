...
import { TicketSliceState, RequestParams, CreateTicketFormData, TicketInterface } from "@Jetzy/types"
import { ServerErrors, Success } from "@Jetzy/lib/_toaster"
import { AppState } from "../stores"
import { CreateTicketApi } from "@Jetzy/services/tickets/ticketsapis"

export const CreateTicketThunk = createAsyncThunk("tickets/createTicket", async (params: RequestParams<CreateTicketFormData>, thunkApi) => {
  return await CreateTicketApi(params)
})

// Initial state
const initialState: TicketSliceState<TicketInterface> = {
  isLoading: false,
  data: undefined,
}
