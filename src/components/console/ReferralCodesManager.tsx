		...
		<Box bg="white" borderRadius="lg" boxShadow="sm" p={0} mb={4} overflow="hidden">
			<Box p={4} borderBottom="1px solid #CED0D4">
				<Flex justify="space-between" align="center">
					<Text fontSize="xl" fontWeight="bold" color="#1C1E21">Referral Codes</Text>
					<Button
						leftIcon={<FiPlus />}
						colorScheme="blue"
						size="sm"
			...
			<Box p={4}>
				{loading ? (
					...
					<Box textAlign="center" py={8}>
						<Text color="#65676B" mb={4}>No referral codes created yet</Text>
						<Button colorScheme="blue" onClick={handleOpenCreate}>Create Your First Code</Button>
					</Box>
				) : (
			...
			<Modal isOpen={isOpen} onClose={onClose} size="lg">
				...
				<ModalContent>
					...
					<ModalFooter>
						...
						<Button colorScheme="blue" onClick={handleCreate} isLoading={creating} isDisabled={!formData.code || formData.discountPercentage < 0 || formData.discountPercentage > 100}>
							Create
						</Button>
					</ModalFooter>
				</ModalContent>
