	...
	return (
		<div className="min-h-full">
			...
			<header className="bg-[#090C10] shadow">
				<div className={`mx-auto px-4 pt-6 xs:px-6 lg:px-8 flex md:flex-row xs:flex-col justify-between gap-4 ${maxW ? maxW : 'max-w-7xl'}`}>
				<Flex flexDirection='column'>
					{backBtn && <Link href={backBtn as string} className="w-max mb-5">
					<Flex alignItems='center' gap='1' border='1px solid #4E4E4E' rounded='lg' px='3' py='1'>
					<BackArrowSVG />
					<Text>Back</Text>
					</Flex>
					</Link>}
