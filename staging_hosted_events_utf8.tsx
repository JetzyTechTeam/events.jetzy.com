				...
				if (storedTickets) {
					try {
						...
						if (Array.isArray(parsedTickets) && parsedTickets.length > 0) {
							...
							console.log("[HostedEvents] Γ£à Restored", ticketsToRestore.length, "tickets from sessionStorage:", ticketsToRestore)
							...
							setTimeout(() => {
								...
								console.log("[HostedEvents] Γ£à Auto-opened checkout form - ready to proceed with same tickets!")
							}, 600)
						} else {
						...
						<div className="text-center">
							...
							{!hasEventEnded && (
								<p className="text-xs text-gray-500 mt-3 font-medium">
									ΓÜí Limited availability - Secure your spot!
								</p>
							)}
